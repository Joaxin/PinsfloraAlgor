...
Given a reference of a node in a **\[connected\]\(**[https://en.wikipedia.org/wiki/Connectivity\_\(graph\_theory\)\#Connected\_graph](https://en.wikipedia.org/wiki/Connectivity_%28graph_theory%29#Connected_graph)**\)** undirected graph.
